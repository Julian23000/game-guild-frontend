...
export default function FriendProgress({ data }) {
  const images = {
    ...
    "pubg: battlegrounds":
      "https://upload.wikimedia.org/wikipedia/en/6/6e/PUBG_Box_cover.jpg",
    "gang beasts":
      "https://upload.wikimedia.org/wikipedia/en/4/41/Gang_Beasts_cover_art.jpg",
  };
  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.percent}>
        his achievements are now at {data.progress}%
      </Text>
    </View>
  );
}
